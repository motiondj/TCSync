// TimecodeTester.cpp
#include "TimecodeTester.h"

UTimecodeTester::UTimecodeTester()
{
    TestDetails = TEXT("No tests run yet");
}

bool UTimecodeTester::TestPLLModule(float Duration)
{
    TestDetails.Empty();
...
bool UTimecodeTester::TestSMPTEModule()
{
    TestDetails.Empty();
...
bool UTimecodeTester::TestIntegratedMode(float Duration)
{
    TestDetails.Empty();
...
void UTimecodeTester::LogTestResult(const FString& TestName, bool bSuccess, const FString& Details)
{
